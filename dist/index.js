...
const ElementContext = /*#__PURE__*/React.createContext(null);
const useElement = () => {
...
const renderElementPlugins = (plugins, renderElementList) => {
  const Tag = elementProps => {
    ...
    const next = () => {
      ...
      if (element) return element;
      return /*#__PURE__*/React.createElement("div", Object.assign({}, elementProps.attributes, (_a = elementProps.element) === null || _a === void 0 ? void 0 : _a.attributes), elementProps.children);
    };
  ...
  return elementProps => {
    ...
    return /*#__PURE__*/React.createElement(ElementContext.Provider, {
      value: elementProps.element
    }, /*#__PURE__*/React.createElement(Tag, Object.assign({}, elementProps)));
  };
};
...
const renderLeafPlugins = (plugins, renderLeafList) => {
  const Tag = props => {
    ...
    return /*#__PURE__*/React.createElement("span", Object.assign({}, leafProps.attributes), leafProps.children);
  };

  return leafProps => {
    // XXX: A wrapper tag component to make useContext get correct value inside.
    return /*#__PURE__*/React.createElement(Tag, Object.assign({}, leafProps));
  };
};
...
const EditablePlugins = _a => {
  ...
  return /*#__PURE__*/React.createElement(slateReact.Editable, Object.assign({
    style: {
      fontSize: 16,
      lineHeight: 1.5
    },
    decorate: React.useCallback(decoratePlugins(editor, plugins, decorateList), [editor, ...[...plugins.flatMap(p => {
      var _a;

      return (_a = p.decorateDeps) !== null && _a !== void 0 ? _a : [];
    }), ...decorateDeps]]),
    renderElement: React.useCallback(renderElementPlugins(plugins, renderElementList), [...plugins.flatMap(p => {
      var _a;

      return (_a = p.renderElementDeps) !== null && _a !== void 0 ? _a : [];
    }), ...renderElementDeps]),
    renderLeaf: React.useCallback(renderLeafPlugins(plugins, renderLeafList), [...plugins.flatMap(p => {
      var _a;

      return (_a = p.renderLeafDeps) !== null && _a !== void 0 ? _a : [];
    }), ...renderLeafDeps]),
    onDOMBeforeInput: React.useCallback(onDOMBeforeInputPlugins(editor, plugins, onDOMBeforeInputList), [editor, ...[...plugins.flatMap(p => {
      var _a;

      return (_a = p.onDOMBeforeInputDeps) !== null && _a !== void 0 ? _a : [];
    }), ...onDOMBeforeInputDeps]]),
    onKeyDown: React.useCallback(onKeyDownPlugins(editor, plugins, onKeyDownList), [editor, ...[...plugins.flatMap(p => {
      var _a;
...
exports.decoratePlugins = decoratePlugins;
exports.getInlineTypes = getInlineTypes;
exports.getVoidTypes = getVoidTypes;
exports.onDOMBeforeInputPlugins = onDOMBeforeInputPlugins;
exports.onKeyDownPlugins = onKeyDownPlugins;
exports.renderElementPlugins = renderElementPlugins;
exports.renderLeafPlugins = renderLeafPlugins;
