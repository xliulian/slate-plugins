...
import { GetElementDeserializerOptions, GetLeafDeserializerOptions } from '../utils';
export declare type DeserializerOptions = GetElementDeserializerOptions | GetLeafDeserializerOptions;
...
export declare type DeserializedAttributes = {
    [key: string]: any;
} | undefined;
...
export interface NodeToPropsOptions<ElementType = Element, RootPropsType = RenderNodePropsOptions> extends Omit<RenderElementPropsWithAttributes, 'element'>, RootProps<RootPropsType> {
    element: ElementType;
}
export interface NodeToProps<ElementType = Element & {
    [key: string]: any;
     ...
     */
    nodeToProps?: (options: NodeToPropsOptions<ElementType, RootPropsType>) => HtmlAttributes;
}
 ...
 */
export interface RenderNodeOptions extends RootProps<RenderNodePropsOptions>, HotkeyOptions {
    /**
     * Type of the node.
     */
    type?: string;
...
//# sourceMappingURL=PluginOptions.types.d.ts.map