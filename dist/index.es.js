import { useContext, createElement, createContext, useCallback } from 'react';
...
const ElementContext = /*#__PURE__*/createContext(null);
const useElement = () => {
...
const renderElementPlugins = (plugins, renderElementList) => {
  const Tag = elementProps => {
    ...
    const next = () => {
      ...
      if (element) return element;
      return /*#__PURE__*/createElement("div", Object.assign({}, elementProps.attributes, (_a = elementProps.element) === null || _a === void 0 ? void 0 : _a.attributes), elementProps.children);
    };
  ...
  return elementProps => {
    ...
    return /*#__PURE__*/createElement(ElementContext.Provider, {
      value: elementProps.element
    }, /*#__PURE__*/createElement(Tag, Object.assign({}, elementProps)));
  };
};
...
export { EditablePlugins, decoratePlugins, getInlineTypes, getVoidTypes, onDOMBeforeInputPlugins, onKeyDownPlugins, renderElementPlugins, renderLeafPlugins, useElement };
