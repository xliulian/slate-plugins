 ...
 */
export declare const toggleNodeType: (editor: Editor, options: ToggleNodeTypeOptions, editorNodesOptions?: Pick<EditorNodesOptions<import("slate").Node>, "at" | "mode" | "universal" | "reverse" | "voids" | "block"> | undefined) => void;
